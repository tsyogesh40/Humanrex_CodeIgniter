...
<head>
    ...
    <link href="<?=base_url()?>assets/source/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/source/staffs/staffs.css" rel="stylesheet">
    <script src="<?=base_url()?>assets/source/jquery-1.11.1.min.js"></script>
    <script src="<?=base_url()?>assets/source/bootstrap-3.3.0/js/bootstrap.min.js"></script>
</head>
<body>
...
<p class="narrow text-center">
  <a  href="<?=base_url()?>user1/logout"  title="Click to Logout" class="btn btn-danger btn-oHputline-rounded green"> LOGOUT <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
</p>
</div>
